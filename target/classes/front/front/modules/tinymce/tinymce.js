//  菜单显示异常Edittinymce/skins/ui/oxide/skin.min.css:96 .tox-silver-sink的z-indexValue
...
layui.define(['jquery'],function (exports) {
    ...
    var settings = {
        base_url: modPath
        , images_upload_url: '/rest/upload'//Photo上传接口，可在option传入，也可在这里Edit，option的Value优先
        , language: 'zh_CN'//语言，可在option传入，也可在这里Edit，option的Value优先
        , response: {//后台Return数据格式设置
        ...
        , success: function (res, succFun, failFun) {//Photo上传完成回调 根据自己需要Edit
