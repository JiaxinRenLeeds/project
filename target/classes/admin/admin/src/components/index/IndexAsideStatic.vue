<template>
  <el-aside class="index-aside" height="100vh" width="280px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#24C2CD">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#24C2CD" text-color="#FFFFFF" active-text-color="#FFFFFF" default-active="0">
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('')"><i v-if="false" class="el-icon-s-home" />Home page</el-menu-item>
          <el-submenu :index="1+''" :style="menulistBorderBottom">
            <template slot="title">
              <i v-if="false" class="el-icon-user-solid" />
              <span>Personal center</span>
            </template>
            <el-menu-item :index="1-1" @click="menuHandler('updatePassword')">Change the password</el-menu-item>
