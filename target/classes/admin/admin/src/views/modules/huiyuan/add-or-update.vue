<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="ID number" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng" 
              placeholder="ID number" clearable  :readonly="ro.shenfenzheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="ID number" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="ID number" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Email" prop="youxiang">
          <el-input v-model="ruleForm.youxiang" 
              placeholder="Email" clearable  :readonly="ro.youxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Email" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="Email" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="Photo" prop="touxiang">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="Photo" prop="touxiang">
...
export default {
  data() {
	...
	touxiang : false,
      ...
      rules: {
          yonghuzhanghao: [
                { required: true, message: 'User account不能为空', trigger: 'blur' },
          ],
          mima: [
