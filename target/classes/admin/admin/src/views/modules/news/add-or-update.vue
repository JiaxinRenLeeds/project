<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Photo" prop="picture">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Photo" prop="picture">
...
export default {
  data() {
	...
	content : false,
      ...
      rules: {
          ...
          picture: [
                { required: true, message: 'Photo不能为空', trigger: 'blur' },
          ],
          content: [
  ...
  methods: {
	...
	this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../springbootnu0q1/upload');
        } else {
