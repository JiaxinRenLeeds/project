<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收藏Picture name" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="收藏Picture name" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收藏Picture name" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="收藏Picture name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="收藏Photo" prop="picture">
          <file-upload
          tip="点击上传收藏Photo"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="收藏Photo" prop="picture">
  ...
  data() {
	...
	picture : false,
      ...
      rules: {
          ...
          name: [
                { required: true, message: '收藏Picture name不能为空', trigger: 'blur' },
          ],
          picture: [
                { required: true, message: '收藏Photo不能为空', trigger: 'blur' },
          ],
      }
    };
  },
