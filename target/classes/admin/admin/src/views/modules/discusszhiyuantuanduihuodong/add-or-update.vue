  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="Comment content" prop="content">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.content" label="Comment content" prop="content">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="Reply content" prop="reply">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.reply" label="Reply content" prop="reply">
...
export default {
  data() {
	...
	reply : false,
      ...
      rules: {
          ...
          content: [
                { required: true, message: 'Comment content不能为空', trigger: 'blur' },
          ],
          reply: [
          ],
      }
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `discusszhiyuantuanduihuodong/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `discusszhiyuantuanduihuodong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.discusszhiyuantuanduihuodongCrossAddOrUpdateFlag = false;
                  this.parent.search();
