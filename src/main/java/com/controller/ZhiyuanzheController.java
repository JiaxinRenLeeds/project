...
public class ZhiyuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhiyuanzhezhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或Password不正确");
		}
		
		String token = tokenService.generateToken(user.getId(), username,"zhiyuanzhe",  "Volunteer" );
    ...
    public R register(@RequestBody ZhiyuanzheEntity zhiyuanzhe){
    	...
    	ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhiyuanzhezhanghao", zhiyuanzhe.getZhiyuanzhezhanghao()));
		if(user!=null) {
			return R.error("Register用户已存在");
		}
    ...
    public R query(ZhiyuanzheEntity zhiyuanzhe){
		...
		return R.ok("查询Volunteer成功").put("data", zhiyuanzheView);
    }
