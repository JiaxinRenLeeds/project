...
public class DiscussliulangdongwuxinxiController {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussliulangdongwuxinxiEntity> wrapper = new EntityWrapper<DiscussliulangdongwuxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussliulangdongwuxinxiService.selectCount(wrapper);
