...
export default {
  ...
  methods: {
    submitTap() {
      // if (!this.name) {
      //   this.$message.error("Please enter the 收款人姓名");
      //   return;
      // }
      // if (!this.account) {
      //   this.$message.error("Please enter the 收款人账号");
      //   return;
      // }
      if (!this.type) {
        this.$message.error("Please choose 支付方式");
        return;
      }
      this.$confirm(`Confirm支付?`, "Reminder", {
