<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Picture name" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="Picture name" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Picture name" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="Picture name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  data() {
	...
	value : false,
      ...
      rules: {
          name: [
                { required: true, message: 'Picture name不能为空', trigger: 'blur' },
          ],
          value: [
          ],
      }
