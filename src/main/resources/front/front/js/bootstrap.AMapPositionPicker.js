...
(function (factory) {
    ...
    function buildBootstrapModalHTML() {
        ...
        var modalHtml = '<div class="modal fade" id="idAMapPositionPickerModal">'
            ...
            + '<div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title">Please choose 地址</h4><small id="idAMapPositionPickerAlert" style="color: red">必须选择一个位置</small></div>'
            ...
            + '<button id="idAMapPositionPickerSelect" type="button" class="btn btn-primary btn-sm">Confirm</button><button id="idAMapPositionPickerCancelBtn" type="button" class="btn btn-default btn-sm" data-dismiss="modal">Cancel</button>'
                    ...
                    AMap.service('AMap.PlaceSearch', function () {
                        ...
                        placeSearch.searchInBounds(searchKeyword, mapObj.getBounds(), function (status, result) {
                            ...
                            if (status == 'complete') {
                                ...
                                $searchPanel.append('<li class="list-group-item disabled"><small>抱歉，暂No找到符合item件的结果。</small></li>');
                            }
                        });
                    });
                }
    ...
    $.fn.AMapPositionPicker.defaults = {
        ...
        required: true,
        title: 'Please choose 地址',
        errorTip: 'Please choose 地址',
        height: '500px',
        fields: []
    };
