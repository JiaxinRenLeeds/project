...
layui.define(['jquery', 'layer'], function(exports) { //Reminder：模块也可以依赖其它模块，如：layui.define('layer', callback);
	"use strict";
	var jquery = layui.jquery,
		layer = layui.layer,
		        baseurl = "http://localhost:8080/springbootnu0q1/";
        	var http = {
		        domain : "http://localhost:8080/springbootnu0q1/",
        		baseurl: baseurl,
		/**
		 * 获取传递参数Value(Edit支持中文)
		 */
